...
const EmailSection = () => {
  return (
    <section className="grid md:grid-cols-2 my-12 md:my-12  gap-4 relative" id="contacto">
      ...
      <div>
        <form className="flex flex-col gap-4" action="https://formsubmit.co/maitedeleonf@gmail.com" method="POST">
          ...
          <textarea name="message"  className="bg-[#181818] border-2 border-[#FB1F5F] placeholder-[#9cada9] text-gray-100 
            text-md rounded-lg block w-full py-2.5 px-1" id="message" cols="10" rows="4" placeholder="Deje su mensaje..." required></textarea>
